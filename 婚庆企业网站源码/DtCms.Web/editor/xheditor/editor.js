 ...
 * @licence LGPL(..\\..\\http\\www.opensource.org\\licenses\\MS_21.html)
 * 
...
var htmlLink='<div>链接地址: <input type="text" id="xhEdtLinkHref" value="http\\MS_22.html" class="text" /></div><div>打开方式: <select id="xhEdtLinkTarget"><option selected="selected" value="">默认</option><option value="_blank">新窗口</option><option value="_self">当前窗口</option><option value="_parent">父窗口</option></select></div><div style="text-align:right;"><input type="button" id="xhEdtSave" value="确定" /></div>';
var htmlImg='<div>图片地址：<input type="text" id="xhEdtImgSrc" value="http\\MS_22.html" class="text" /></div><div>替换文本：<input type="text" id="xhEdtImgAlt" /></div><div>对齐方式：<select id="xhEdtImgAlign"><option selected="selected" value="">默认</option><option value="left">左对齐</option><option value="right">右对齐</option><option value="top">顶端</option><option value="middle">居中</option><option value="baseline">基线</option><option value="bottom">底边</option></select></div><div>宽度高度：<input type="text" id="xhEdtImgWidth" style="width:40px;" /> x <input type="text" id="xhEdtImgHeight" style="width:40px;" /></div><div>边框大小：<input type="text" id="xhEdtImgBorder" style="width:40px;" /></div><div>水平间距：<input type="text" id="xhEdtImgHspace" style="width:40px;" /> 垂直间距：<input type="text" id="xhEdtImgVspace" style="width:40px;" /></div><div style="text-align:right;"><input type="button" id="xhEdtSave" value="确定" /></div>';
var htmlFlash='<div>动画地址：<input type="text" id="xhEdtFlashSrc" value="http\\MS_22.html" class="text" /></div><div>宽度高度：<input type="text" id="xhEdtFlashWidth" style="width:40px;" value="480" /> x <input type="text" id="xhEdtFlashHeight" style="width:40px;" value="400" /></div><div style="text-align:right;"><input type="button" id="xhEdtSave" value="确定" /></div>';
var htmlMedia='<div>视频地址：<input type="text" id="xhEdtMediaSrc" value="http\\MS_22.html" class="text" /></div><div>宽度高度：<input type="text" id="xhEdtMediaWidth" style="width:40px;" value="480" /> x <input type="text" id="xhEdtMediaHeight" style="width:40px;" value="400" /></div><div style="text-align:right;"><input type="button" id="xhEdtSave" value="确定" /></div>';
...
var htmlAbout='<div style="width:200px;word-wrap:break-word;word-break:break-all;"><p><span style="font-size:20px;color:#1997DF;">xhEditor</span><br />版本：v0.9.9 build 20091123</p><p>xhEditor是一个基于jQuery开发的跨平台开源迷你XHTML编辑器组件。</p><p><a href="..\\..\\http\\xheditor.com\\MS_20.html" target="_blank">http://xheditor.com/</a></p></div>';
...
{
	var defaults={skin:'default',tools:'full',internalScript:true,inlineScript:true,internalStyle:true,inlineStyle:true,showBlocktag:false,forcePtag:true,keepValue:true,upLinkExt:"zip,rar,txt",upImgExt:"jpg,jpeg,gif,png",upFlashExt:"swf",upMediaExt:"avi",modalWidth:350,modalHeight:220,modalTitle:true,baseUrl:baseURL,attachLinkText:'点击打开链接'};
	...
	var bodyClass='',skinPath=jsURL+'skins\\index.html'+_this.settings.skin+'..\\..\\index.html';
	...
	this.processHTML=function(sHtml,mode)
	{
		...
		{//write
			...
			{
				sHtml = sHtml.replace(..\\..\\(.html"|;)\s*font-size\s*:\s*([a-z-]+)(;?)/ig,function(all,pre,sname,aft){
					var t,s;
		...
		{//read
			if(_this.settings.keepValue)//恢复属性值
			{
				...
				{
					attrs=attrs.replace(new RegExp('\\MS_23.html'+n+'\\s*=\\s*(["\']?)[^"\'\\s]*\\1','ig'),' '+n+'="'+v+'"');
					return '<'+tag+attrs+'>';
				}
	...
	this.showFlash=function()
	{
		...
		jSave.click(function(){
			...
			if(sSrc!='')
			{
				if(jParent.size()==0)
				{
					_this.pasteHTML('<embed type="application/x-shockwave-flash" src="editor.js" wmode="opaque" quality="high" menu="false" play="true" loop="true" />');
	...
	this.showMeida=function()
	{
		...
		jSave.click(function(){
			...
			if(sSrc!='')
			{
				if(jParent.size()==0)
				{
					_this.pasteHTML('<embed type="application/x-mplayer2" src="editor.js" enablecontextmenu="false" autostart="false" />');
					jParent=$('embed[src$="#xhedt_tempurl"]',_doc);
				}
				_this.attr(jParent,'src',sSrc);
				var w=jWidth.val(),h=jHeight.val(),reg=/^[0-9]+$/;
	...
	{
		var jEmot=$('<div class="xhEdtEmot"></div>'),jLine,jItem,c=0,sEmotPath=jsURL+'emot\\default\\index.html';
		jLine=$('<div></div>');
...
$(function(){
$('textarea.xheditor').xheditor(true,{upImgUrl:"MS_24.html",upImgExt:"jpg,jpeg,gif,png,bmp",upFlashUrl:"MS_25.html",upFlashExt:"swf",upMediaUrl:"MS_26.html",upMediaExt:"avi"});
