...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="List.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 业务管理 &gt; 编辑业务</b>
    </div>
    <div style="padding-bottom:10px;"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tr>
            <th colspan="2" align="left">编辑业务</th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtImgUrl" runat="server" CssClass="input w380 left" HintTitle="图片" HintInfo="请在右边“选择/上传”上传大图，自动生成缩位图。"></asp:TextBox>
