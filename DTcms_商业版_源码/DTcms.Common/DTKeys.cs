...
namespace DTcms.Common
{
    public class DTKeys
    {
        ...
        /// 安全码
        /// </summary>
        public const string SECURITY_CODE = "6DB4X0D2";
        /// <summary>
        /// 加密/解密－密匙
        /// </summary>
        public const string ENCRYPT_KEY = "4J6202XB";
        /// <summary>
        /// Cookie 加密密匙
        /// </summary>
        public const string COOKIE_KEY = "64N0HF4V";
        /// <summary>
        /// 用户名称密码缓存
        /// </summary>
        public const string COOKIE_ENCRYPT = "20DV4682";
        ...
        /// 编辑器配置文件
        /// </summary>
        public const string FILE_EDITOR_XML_CONFING = "Editorpath";
