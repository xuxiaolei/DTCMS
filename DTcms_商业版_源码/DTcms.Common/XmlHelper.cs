...
namespace DTcms.Common
{
    public class XmlHelper
    {
        ...
        /// 读取XML的节点值
        /// </summary>
        /// <param name="xmlstr">xml对象</param>
        /// <param name="xPath">XPath节点</param>
        /// <returns></returns>
        public static string GetNodesValue(string xmlstr, string xPath)
        {
            try
            {
                ...
                return root.SelectSingleNode(xPath).InnerText.ToString();
            }
            catch
            {
                return string.Empty;
        ...
        /// <param name="value">节点的值</param>
        /// <returns></returns>
        public static bool UpdateNodesValue(string filePath, int index, string value)
        {
            try
            {
                XmlDocument doc = new XmlDocument();
                ...
                xnList.Item(index).InnerText = value;
                doc.Save(filePath);
            }
            catch
            {
