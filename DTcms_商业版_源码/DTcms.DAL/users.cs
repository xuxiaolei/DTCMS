...
namespace DTcms.DAL
{
    ...
    public partial class users
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + this.column + " from [" + databaseprefix + "users] where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 " + this.column + " from [" + databaseprefix + "users] where (user_name=@user_name");
            if (emaillogin == 1)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 " + this.column + " from [" + databaseprefix + "users] where user_name=@user_name and status<3");
            SqlParameter[] parameters = {
					new SqlParameter("@user_name", SqlDbType.NVarChar,100)};
            parameters[0].Value = user_name;
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" " + this.column + " from [" + databaseprefix + "users]");
            if (strWhere.Trim() != "")
            {
