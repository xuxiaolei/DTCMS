...
namespace DTcms.DAL
{
    ...
    public partial class article_tags
    {
        ...
        public article_tags(string _databaseprefix)
        {
            ...
            this.column = "id,title,is_red,sort_id,add_time,call_index,seo_title,seo_keywords,seo_description";
        }
        ...
        public int Add(Model.article_tags model)
        {
            ...
            strSql.Append("title,is_red,sort_id,add_time,call_index,seo_title,seo_keywords,seo_description");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 " + this.column + " from [" + databaseprefix + "article_tags]");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,title,call_index,is_red,sort_id,add_time,(select count(0) from " + databaseprefix + "article_tags_relation where tag_id=" + databaseprefix + "article_tags.id) as count");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,title,call_index,is_red,sort_id,add_time,(select count(0) from " + databaseprefix + "article_tags_relation where tag_id=" + databaseprefix + "article_tags.id) as count");
            strSql.Append(" FROM " + databaseprefix + "article_tags");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
