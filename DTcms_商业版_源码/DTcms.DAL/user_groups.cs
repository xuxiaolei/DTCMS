...
namespace DTcms.DAL
{
    ...
    public partial class user_groups
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,title,grade,upgrade_exp,upgrade_price,amount,point,discount,is_default,is_upgrade,is_lock");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,title,grade,upgrade_exp,amount,upgrade_price,point,discount,is_default,is_upgrade,is_lock ");
            strSql.Append(" FROM " + databaseprefix + "user_groups ");
            if (strWhere.Trim() != "")
            {
