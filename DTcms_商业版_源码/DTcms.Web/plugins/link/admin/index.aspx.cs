...
namespace DTcms.Web.Plugin.Link.admin
{
    public partial class index : DTcms.Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("index.aspx", "site_id={0}&keywords={1}&page={2}", this.site_id.ToString(), this.keywords, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("index.aspx", "site_id={0}&keywords={1}", this.site_id.ToString(), txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("index.aspx", "site_id={0}&keywords={1}", this.site_id.ToString(), this.keywords));
        }
        ...
        protected void lbtnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功！", Utils.CombUrlTxt("index.aspx", "site_id={0}&keywords={1}", this.site_id.ToString(), this.keywords));
        }
        ...
        protected void lbtnUnLock_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量审核成功！", Utils.CombUrlTxt("index.aspx", "site_id={0}&keywords={1}", this.site_id.ToString(), this.keywords));
        }
        ...
        protected void lbtnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("index.aspx", "site_id={0}&keywords={1}", this.site_id.ToString(), this.keywords));
        }
