    ...
    public partial class bar_list : DTcms.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                TreeBind(); //绑定广告位
                RptBind(CombSqlTxt(this.aid, this.keywords), "is_lock asc,sort_id asc,add_time desc");
            }
        }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            this.rptList.DataSource = bll.GetList(_strWhere, _orderby, this.page, this.pageSize, out this.totalCount);
