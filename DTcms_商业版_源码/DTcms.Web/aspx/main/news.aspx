...
{
	cacheFile = "/aspx/main/cache/news_" + page + ".cache";
...
protected override void Render( HtmlTextWriter writer )
{
	...
	DataTable MainMenu = get_plugin_method("DTcms.Web.Plugin.Menu", "menu", "get_menu_content", 10, 1);
	...
	if (""!=Utils.ObjectToStr(dr["css_txt"]))
	{

	templateBuilder.Append(" class=\"" + Utils.ObjectToStr(dr["css_txt"]) + "\"");
	}	//end for if

	templateBuilder.Append(" target=\"" + Utils.ObjectToStr(dr["open_mode"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a>\r\n            ");
	}	//end for if
	...
	templateBuilder.Append("\r\n        <li>\r\n          <h4><a href=\"");
	templateBuilder.Append(queryurl("news_list",Utils.ObjectToStr(cdr1["call_index"]),Utils.ObjectToStr(cdr1["id"])));
	...
	templateBuilder.Append("\r\n            <a href=\"");
	templateBuilder.Append(queryurl("news_list",Utils.ObjectToStr(cdr2["call_index"]),Utils.ObjectToStr(cdr2["id"])));
	...
	templateBuilder.Append(queryurl("news_show",Utils.ObjectToStr(hotdr["call_index"]),Utils.ObjectToStr(hotdr["id"])));
