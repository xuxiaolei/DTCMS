...
<div class="tab-content">
  ...
  <%if (model.api_path.ToLower() == "alipaypc" || model.api_path.ToLower() == "alipaymb")
    { %>
  <dl>
    <dt>支付宝账号</dt>
    <dd>
  ...
  <%}
    else if (model.api_path.ToLower() == "wxapipay" || model.api_path.ToLower() == "wxnatpay")
    { %>
  <dl>
    <dt>商户号</dt>
    <dd>
      <asp:TextBox ID="txtWxPartner" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
      <span class="Validform_checktip">*微信支付的商户号</span>
    </dd>
  </dl>
  <dl>
    <dt>支付密钥</dt>
    <dd>
      <asp:TextBox ID="txtWxKey" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
      <span class="Validform_checktip">*商户支付密钥，进入微信支付【账户设置】【API安全】设置</span>
    </dd>
  </dl>
  <dl>
    <dt>AppID</dt>
    <dd>
      <asp:TextBox ID="txtWxAppId" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
      <span class="Validform_checktip">*微信公众号的AppID(应用ID)</span>
    </dd>
  </dl>
  <%if (model.api_path.ToLower() == "wxapipay")
    { %>
  <dl>
    <dt>AppSecret</dt>
    <dd>
      <asp:TextBox ID="txtWxAppSecret" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
      <span class="Validform_checktip">*微信公众号的AppSecret(应用密钥)</span>
    </dd>
  </dl>
  <%} %>
  <%} %>
