...
<div class="tab-content">
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="cbIsAttr" runat="server" />
      </div>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
        <asp:RadioButtonList ID="rblIsType" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
          ...
          <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="100%">
            ...
            <tbody id="item_box">
              ...
              <tr class="td_c">
                ...
                <td>
                  <input type="hidden" name="item_cache" value="<%#Eval("cache")%>" />
                  <input type="hidden" name="item_path" value="<%#Eval("cachepath")%>" />
                  <span class="item_cache"><%#Eval("cache").ToString() != "1" ? "-" : "是"%></span>
                </td>
                <td>
