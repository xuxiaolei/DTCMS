  ...
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        ...
        <li><a href="javascript:;">百度推送</a></li>
      </ul>
    </div>
  </div>
</div>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlSiteId" runat="server" datatype="*" sucmsg=" " ></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
...
<div class="tab-content" style="display:none;">
  ...
  <dl>
    <dt>首页标题(SEO)</dt>
    <dd>
      <asp:TextBox ID="txtSeoTitle" runat="server" CssClass="input normal" TextMode="MultiLine" />
  ...
  <dl>
    <dt>页面关健词(SEO)</dt>
    <dd>
      <asp:TextBox ID="txtSeoKeyword" runat="server" CssClass="input normal" TextMode="MultiLine" />
  ...
  <dl>
    <dt>页面描述(SEO)</dt>
    <dd>
      <asp:TextBox ID="txtSeoDescription" runat="server" CssClass="input normal" TextMode="MultiLine" />
...
<div class="tab-content" style="display:none;">
   <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="bdSend" runat="server" />
      </div>
      <span class="Validform_checktip">*建议只有在正式环境中使用。</span>
    </dd>
  </dl>
   <dl>
    <dt>TOKEN</dt>
    <dd>
      <asp:TextBox ID="bdToken" runat="server" CssClass="input normal" />
      <span class="Validform_checktip">准入密钥(description)</span>
    </dd>
  </dl>
</div>
<!--/内容-->
