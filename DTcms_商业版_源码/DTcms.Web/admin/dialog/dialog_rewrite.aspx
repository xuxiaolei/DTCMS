...
<script type="text/javascript">
    ...
    function createVarHtml() {
        ...
        + '<td><select class="select1" onchange="setVal(this, \'varName\');"><option value="">@规定参数</option><option value="id">文章ID</option><option value="category_id">类别ID</option><option value="call_index">调用别名</option><option value="page">分页页码</option></select>\n'
