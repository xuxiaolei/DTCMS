...
namespace DTcms.Web.admin.manager
{
    public partial class manager_pwd : Web.UI.ManagePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (DESEncrypt.Encrypt(txtOldPassword.Text.Trim(), model.salt + DTKeys.SECURITY_CODE) != model.password)
            {
                JscriptMsg("旧密码不正确！", "");
                return;
            }
            ...
            model.password = DESEncrypt.Encrypt(txtPassword.Text.Trim(), model.salt + DTKeys.SECURITY_CODE);
