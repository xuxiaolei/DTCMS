    ...
    public partial class comment_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                //审核权限
                if (!ChkAuthority("channel_" + this.channel_name + "_comment", DTEnums.ActionEnum.Audit.ToString()))
                {
                    this.auditBtnPannel.Visible = false;
                }
                //删除权限
                if (!ChkAuthority("channel_" + this.channel_name + "_comment", DTEnums.ActionEnum.Delete.ToString()))
                {
