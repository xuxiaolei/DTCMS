...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li runat="server" id="addBtnPannel"><a class="add" href="category_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增</span></a></li>
          ...
          <li runat="server" id="delBtnPannel"><asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete','本操作会删除本类别及下属子类别，是否继续？');" onclick="btnDelete_Click"><i></i><span>删除</span></asp:LinkButton></li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td align="left"><asp:LinkButton ID="lbtnPage" CommandName="lbtnPage" runat="server" CssClass='<%# Convert.ToInt32(Eval("is_page")) == 1 ? "btnRed" : "btnGray"%>' Text='<%# Convert.ToInt32(Eval("is_page")) == 1 ? "√" : "×"%>' /></td>
      <td align="left"><asp:LinkButton ID="lbtnExamine" CommandName="lbtnExamine" runat="server" CssClass='<%# Convert.ToInt32(Eval("is_lock")) == 1 ? "btnRed" : "btnGray"%>' Text='<%# Convert.ToInt32(Eval("is_lock")) == 0 ? "√" : "×"%>' /></td>
