...
<script type="text/javascript">
    ...
    function showChooseDialog(obj, sidername) {
        var d = top.dialog({
            id: 'dialogChoose',
            title: '相关信息选择',
            url: 'dialog/dialog_choose.aspx?channel_id=<%=channel_id %>&sidername=' + sidername,
            width: 800,
            onclose: function () {
  ...
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        ...
        <li id="attribute_tab_item" runat="server" visible="false" ><a href="javascript:;">自定义参数</a></li>
...
<div class="tab-content">
  ...
  <dl ID="div_stock_quantity" runat="server" visible="false">
    ...
    <dd>
      <asp:TextBox ID="field_control_stock_quantity" runat="server" CssClass="input mark" datatype="n" sucmsg=" ">0</asp:TextBox>
  ...
  <dl ID="div_market_price" runat="server" visible="false">
    ...
    <dd>
      <asp:TextBox ID="field_control_market_price" runat="server" CssClass="input mark" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">0</asp:TextBox> 元
  ...
  <dl ID="div_sell_price" runat="server" visible="false">
    ...
    <dd>
      <asp:TextBox ID="field_control_sell_price" runat="server" CssClass="input mark" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">0</asp:TextBox> 元
  ...
  <dl ID="div_point" runat="server" visible="false">
    ...
    <dd>
      <asp:TextBox ID="field_control_point" runat="server" CssClass="input mark" datatype="/^-?\d+$/" sucmsg=" ">0</asp:TextBox>
        ...
        <ul>
          <asp:Repeater ID="rptAlbumList" runat="server">
            ...
            <li>
              ...
              <input type="hidden" name="hid_photo_sort" class="hid_photo_sort" value="<%#Eval("sort_id")%>" />
              ...
              <a href="javascript:;"  class="viewImg" onclick="ajaxLoadImg(this);">浏览</a>
              <a href="javascript:;" onclick="forward(this);" class="qianBox" title="前移">←</a><a href="javascript:;" onclick="behind(this);" class="houBox" title="后移">→</a>
            </li>
            </ItemTemplate>
          </asp:Repeater>
        </ul>
...
<div class="tab-content" style="display:none">
  ...
  <dl ID="div_source" runat="server" visible="false">
    ...
    <dd>
      ...
      <%=Utils.ShowDropDownList(siteConfig.source, "field_control_source")%>
  ...
  <dl ID="div_author" runat="server" visible="false">
    ...
    <dd>
      ...
      <%=Utils.ShowDropDownList(siteConfig.author, "field_control_author")%>
...
<div  ID="attribute_tab_content" runat="server" visible="false" class="tab-content" style="display:none">
  <dl>
    <dt>详细参数</dt>
    <dd>
      <a class="icon-btn add" onclick="addAttribute()"><span>增加一行</span></a>
      <div id="showAttributeList">
        <ul class="argument" id="addcloumn">
          <asp:Repeater ID="rptAttributeList" runat="server">
            <ItemTemplate>
              <li>
                <input name="hid_attribute_name" type="text" class="input small" placeholder="名称" value="<%#Eval("title")%>" />
                <input name="hid_attribute_value" type="text" class="input normal" placeholder="内容" value="<%#Eval("value")%>" />
                <i class="icon"></i>
                <a href="javascript:;" onclick="delAttributeNode(this);" class="del" title="删除">删除</a>
              </li>
            </ItemTemplate>
