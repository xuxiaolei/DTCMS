...
<div class="tab-content">
  ...
  <dl>
    <dt>等级值：</dt>
    <dd>
      <asp:TextBox ID="txtGrade" runat="server" CssClass="input mark" datatype="n" sucmsg=" "></asp:TextBox>
  ...
  <dl>
    <dt>升级所需经验：</dt>
    <dd>
      <asp:TextBox ID="txtUpgradeExp" runat="server" CssClass="input mark" datatype="/^-?\d+$/" sucmsg=" "></asp:TextBox>
      <span class="Validform_checktip">*自动升级所需要的经验值。</span>
    </dd>
  </dl>
  <dl>
    <dt>升级所需冲值金额：</dt>
    <dd>
      <asp:TextBox ID="txtUpgradePrice" runat="server" CssClass="input mark" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" "></asp:TextBox>
      <span class="Validform_checktip">*自动升级所需要一次冲值的金额，0为不参与。</span>
    </dd>
  </dl>
  <dl>
    <dt>初始金额：</dt>
    <dd>
      <asp:TextBox ID="txtAmount" runat="server" CssClass="input mark" datatype="/^-?(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" "></asp:TextBox>
  ...
  <dl>
    <dt>初始积分：</dt>
    <dd>
      <asp:TextBox ID="txtPoint" runat="server" CssClass="input mark" datatype="/^-?\d+$/" sucmsg=" "></asp:TextBox>
  ...
  <dl>
    <dt>购物折扣：</dt>
    <dd>
      <asp:TextBox ID="txtDiscount" runat="server" CssClass="input mark" datatype="n" sucmsg=" "></asp:TextBox>
