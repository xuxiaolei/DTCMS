...
namespace DTcms.Web.admin
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Utils.WriteCookie("temp[0]", DTKeys.COOKIE_ENCRYPT, DESEncrypt.Encrypt(model.user_name, DTKeys.COOKIE_KEY));
            Utils.WriteCookie("temp[1]", DTKeys.COOKIE_ENCRYPT, DESEncrypt.Encrypt(model.password, DTRequest.GetIP()));
