...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\" />\r\n    <meta name=\"author\" content=\"www.dtmao.cc\">\r\n<!--    /*\r\n     * *************************************************\r\n                           (0 0)\r\n       +-------------oOO----(_)----------------+\r\n       |          Powered By : DTmao            |\r\n       |          http://www.dtmao.cc           |\r\n       |             QQ:809451989             |\r\n       |        E-mail:809451989@qq.com        |\r\n       |       专注 DTcms /模板/插件/二次开发                   |\r\n       +--------------------------oOO----------+\r\n                          |__|__|\r\n                           || ||\r\n                          ooO Ooo\r\n     * *************************************************\r\n    */-->\r\n</head>\r\n<body class=\"nobanner\">\r\n    <!--Header-->\r\n    ");
	...
	DataTable worksList = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "works_list", category_id, "__id__");

	templateBuilder.Append("<!--取得一个分页DataTable-->\r\n                        ");
	foreach(DataRow dr in worksList.Rows)
	{

	templateBuilder.Append("\r\n                        <div class=\"projectitem\">\r\n                            <a href=\"");
	templateBuilder.Append(linkurl("works_show",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\" target=\"_blank\">\r\n                                <img src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" width=\"500\" height=\"320\" /><div class=\"project_info\">\r\n                                    <div>\r\n                                        <p class=\"title\">\r\n                                            " + Utils.ObjectToStr(dr["title"]) + "</p>\r\n                                        <p class=\"subtitle\">\r\n                                            " + Utils.ObjectToStr(dr["sub_title"]) + "</p>\r\n                                    </div>\r\n                                </div>\r\n                            </a>\r\n                        </div>\r\n                        ");
	}	//end for if
