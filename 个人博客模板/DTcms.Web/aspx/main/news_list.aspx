...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n                    <div class=\"newstitem\">\r\n                        <div class=\"newscontent\">\r\n                            <a class=\"newsinfo fl\" target=\"_blank\" href=\"");
	templateBuilder.Append(linkurl("news_show",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\">\r\n                                <img src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" class=\"hide\" /><div class=\"newsdate fl wow fadeInLeft\" data-wow-delay=\".1s\">\r\n                                    <p class=\"md\">\r\n                                        ");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(dr["add_time"])).ToString("MM-dd"));

	templateBuilder.Append("</p>\r\n                                    <p class=\"year\">\r\n                                        ");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(dr["add_time"])).ToString("yyyy"));

	templateBuilder.Append("</p>\r\n                                </div>\r\n                                <div class=\"newsbody fl wow fadeInRight\" data-wow-delay=\".1s\">\r\n                                    <p class=\"title ellipsis\">\r\n                                        " + Utils.ObjectToStr(dr["title"]) + "</p>\r\n                                    <p class=\"description\">\r\n                                        " + Utils.ObjectToStr(dr["zhaiyao"]) + " ...</p>\r\n                                </div>\r\n                            </a><i class=\"fa fa-angle-right fr\"></i>\r\n                        </div>\r\n                    </div>\r\n                    ");
	}	//end for if
